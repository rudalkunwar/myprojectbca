...
<div id="addmodal" style="position:fixed; inset: 0; background-color:white; z-index: 500; display:flex; justify-content:center; display:none;">
     
<center>

<div onclick="remove()" style="cursor: pointer;">&times;</div>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
           ...
           Doctors    
  <a onclick="show()" class="btn btn-primary btn-block" style="width:15%; float:right; "><i class="fas fa-user-plus mr-2"></i> Add Doctor</a>
